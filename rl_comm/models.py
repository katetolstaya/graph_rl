...
def make_mlp_model():
    ...
    return snt.Sequential([
        snt.nets.MLP([LATENT_SIZE] * NUM_LAYERS, activate_final=True, activation=tf.tanh, with_bias=False), snt.LayerNorm()
    ])
...
def make_linear_model():
    ...
    """
    return snt.nets.MLP([LATENT_SIZE], activate_final=False, with_bias=False)
